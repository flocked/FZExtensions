...
public extension NSUIColor {
    ...
    var luminosity: CGFloat {
        ...
        let coreColour = CIColor(color: self)
#endif
        let rgb: [CGFloat] = [coreColour.red.clamped(1.0), coreColour.green.clamped(1.0), coreColour.blue.clamped(1.0)]
    ...
    func withLuminosity(_ newLuminosity: CGFloat) -> NSUIColor {
        ...
        let red = coreColour.red.clamped(1.0)
        let green = coreColour.green.clamped(1.0)
        let blue = coreColour.blue.clamped(1.0)
